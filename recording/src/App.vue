          ...
          transition(name="slide-fade")
            div.step(v-show="step === 3")
              ...
              div.form-group
                  ...
                  input(v-model="formReg.month", type="text", class="form-control", id="month")
              div.form-group
                  label(for="times") Время
                  input(v-model="formReg.times", type="text", class="form-control", id="times")
              button(type="button", @click="backStep" class="btn btn-light mt-3") Назад
              button(type="submit", class="btn btn-primary mt-3") Записаться
