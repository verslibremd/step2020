...
//alert(user.name);
// Добавить свойство-- user.gender = "man";
// удалить свойство-- delete user.age;
// alert(user["how many hands"]); -- в кводрадных скобках, если ключ св-ва из нескольких слов

//Здесь переменная key может быть вычислена во время выполнения кода или зависеть от пользовательского ввода.
// После этого мы используем её для доступа к свойству. Это даёт нам большую гибкость. Пример:

//let key = prompt("что вы хотите узнать о пользователе ?","name");
// доступ к свойству через переменную
//alert(user[key]);

/*let fruit = prompt("какой фрукт купить","apple,banana");
